...
export function FolderGrid({ items, mobileTwoColumns = false, onFolderMenu }: { items: FolderItem[]; mobileTwoColumns?: boolean; onFolderMenu?: (event: MouseEvent<HTMLElement>, folder: FolderItem) => void }) {
  return (
